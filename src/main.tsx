      ...
      <main className="main-content">
        <header className="topbar no-print budget-topbar">
          ...
          <div className="top-actions"><span className={`sync-badge ${syncState}`}>{syncMessage}</span>
            <div className="tool-switcher" aria-label="Connected tools"><button onClick={()=>window.location.href=calendarUrl}><CalendarDays size={16}/> Calendar</button><button className="active" aria-current="page"><DollarSign size={16}/> Budget</button><button onClick={()=>window.location.href=bibleUrl}><BookOpen size={16}/> Bible</button></div>
